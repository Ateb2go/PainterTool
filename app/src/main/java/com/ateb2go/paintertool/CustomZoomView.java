 ...
 * Zooming view.
 */
public class CustomZoomView extends FrameLayout {
    ...
    private boolean scrolling=false; // NOPMD by karooolek on 29.06.11 11:45
    ...
    public CustomZoomView(final Context context) {
        super(context);
    }
    ...
    public boolean dispatchTouchEvent(final MotionEvent ev) {
        ...
        if(zoom<=1.0f) setMiniMapEnabled(false);
        else setMiniMapEnabled(true);
